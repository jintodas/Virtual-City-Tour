const weatherAddisAbaba = 'https://api.openweathermap.org/data/2.5/weather?q=addis%20ababa&units=metric&appid=a16a3ff4bd0eb2feb620a341adc49d95';

async function getWeather() {
    const response = await fetch(weatherAddisAbaba);
